...
export default function SeriesCard({ series, wide = false }: { series: Series; wide?: boolean }) {
  return (
    ...
    >
      ...
      <span className="absolute left-2.5 top-2.5 whitespace-nowrap rounded-full bg-jade-500/25 px-2 py-0.5 text-[9px] font-bold text-jade-500 backdrop-blur">
        {copy.home.freeBadgeShort(series.freeEpisodeCount)}
      </span>
